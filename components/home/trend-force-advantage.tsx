...
//             <p className="text-red-primary mb-3 bg-[#ED1C2414] font-bold py-2 px-6 rounded-sm w-44 whitespace-nowrap">
//               Why TrendForce?
//             </p>
...
//             {/* Card 1 */}
//             <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-2 items-start max-w-[600px] xl:max-w-[750px]">
...
//                   <Image
//                     src="/assets/home-images/idea.svg"
//                     alt="service-icon"
//                     width={40}
//                     height={40}
//                     className="h-5 w-5"
//                   />
//                 </div>
//                 <h4 className="text-[14px] md:text-2xl font-bold">
//                   Insight-Driven Approach
//                 </h4>
//               </div>
//               <div>
//                 <p className="text-gray-600 text-[14px] md:text-lg">
//                   Every recommendation is grounded in rigorous data, research,
//                   and modeling.
//                 </p>
//               </div>
//             </div>
...
//                 <div className="bg-[#FFE3E6A1] h-8 w-8 md:h-10 md:w-10 flex items-center justify-center rounded-full">
//                   <Image
//                     src="/assets/home-images/bars.svg"
//                     alt="service-icon"
//                     width={40}
//                     height={40}
//                     className="h-5 w-5"
...
//                 <div className="bg-[#FFE3E6A1] h-8 w-8 md:h-10 md:w-10 flex items-center justify-center rounded-full">
//                   <Image
//                     src="/assets/home-images/results.svg"
//                     alt="service-icon"
//                     width={40}
//                     height={40}
//                     className="h-5 w-5 "
        ...
        <div className="w-full lg:w-1/2 xl:w-auto flex flex-col justify-center items-center lg:justify-start lg:items-start">
          ...
          <div className="mt-10 flex flex-col gap-6">
            {cards.map((card, i) => (
              <div
                key={i}
                className="bg-white p-6 rounded-2xl shadow-md flex flex-col gap-2 items-start max-w-[600px] xl:max-w-[750px]"
              >
                <div className="flex flex-row items-center gap-0 md:gap-2">
                  <div className="bg-[#FFE3E6A1] h-8 w-8 md:h-10 md:w-10 flex items-center justify-center rounded-full">
                    <Image
